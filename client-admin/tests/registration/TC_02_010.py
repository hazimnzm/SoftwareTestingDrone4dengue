...
# Test Case Data (TC-02-010)
BASE_URL = "http://localhost:3000"
SIGNUP_URL = f"{BASE_URL}/signup"
TEST_DATA = {
    "FullName": "Muhammad Hazim",
    "Email": "hazim010@um.edu.my",
    "UserName": "hazim_010",
...
def test_password_exactly_8():
    """Verify that registration succeeds with a password exactly 8 characters long."""
    ...
    try:
        ...
        print("\n" + "="*30)
        print("TEST CASE TC-02-010: PASSED")
        print("="*30)

    except Exception as e:
        print("\n" + "!"*30)
        print(f"TEST CASE TC-02-010: FAILED")
        print(f"Error: {str(e)}")
        print("!"*30)
        driver.save_screenshot("test_tc_02_010_failure.png")
        raise e
