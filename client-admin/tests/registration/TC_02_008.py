...
# Test Case Data (TC-02-008)
BASE_URL = "http://localhost:3000"
SIGNUP_URL = f"{BASE_URL}/signup"
TEST_DATA = {
    "FullName": "Muhammad Hazim",
    "Email": "hazim008@um.edu.my",
    "UserName": "hazim_008",
...
def test_password_too_short():
    """Verify that registration fails if password is too short (7 characters)."""
    ...
    try:
        ...
        print("Verifying UI warning for short password...")
        
        # The system uses a combined message: "Password must be at least 8 characters and include a number"
        error_msg_xpath = "//p[contains(text(), 'Password must be at least 8 characters')]"
        ...
        if "at least 8 characters" in error_msg.text.lower():
            print("Confirmed: Short password error displayed.")
        else:
        ...
        print("\n" + "="*30)
        print("TEST CASE TC-02-008: PASSED")
        print("="*30)

    except Exception as e:
        print("\n" + "!"*30)
        print(f"TEST CASE TC-02-008: FAILED")
        print(f"Error: {str(e)}")
        print("!"*30)
        driver.save_screenshot("test_tc_02_008_failure.png")
        raise e
